...
public class DapAnDB {
    ...
    public static  List<DapAn> getOne(String maDe1) throws SQLException{
        String sql=String.format("select * from dapan where MaDe='%s'",maDe1);
    ...
    public static  List<DapAn> getAll() throws SQLException{
        String sql=String.format("select * from dapan ");
        List<DapAn> list=null;
        try {
            list=new ArrayList<DapAn>();
            Connection  con=Util.getConnection();
